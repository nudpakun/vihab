...
class Blog extends API
{
	 ...
	 * @apiParam {String} [Field="All Field"] Optional field of Blogs : id, title, slug, content, image, tags, category, status, author, viewers, created_at, updated_at.
	...
	public function all_get()
	{
		...
		$select_field = ['id', 'title', 'slug', 'content', 'image', 'tags', 'category', 'status', 'author', 'viewers', 'created_at', 'updated_at'];
