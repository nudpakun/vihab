...
<section class="content-header">
    <h1>
        Form Workout Log        <small><?= cclang('new', ['Form Workout Log']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Form Workout Log']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="patient_id" id="patient_id" placeholder="Patient Id" value="<?= set_value('patient_id'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="average_accuracy" id="average_accuracy" placeholder="Average Accuracy" value="<?= set_value('average_accuracy'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="average_time" id="average_time" placeholder="Average Time" value="<?= set_value('average_time'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="average_pain_score" id="average_pain_score" placeholder="Average Pain Score" value="<?= set_value('average_pain_score'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pain_face" id="pain_face" placeholder="Pain Face" value="<?= set_value('pain_face'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pain_motion" id="pain_motion" placeholder="Pain Motion" value="<?= set_value('pain_motion'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pain_scream" id="pain_scream" placeholder="Pain Scream" value="<?= set_value('pain_scream'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pain_restless" id="pain_restless" placeholder="Pain Restless" value="<?= set_value('pain_restless'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/form_workout_log/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
