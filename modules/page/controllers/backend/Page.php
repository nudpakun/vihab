	...
	public function detail($slug = null)
	{
        ...
        switch($page->title){
            ...
            case "patient":
                ...
                //Get Input ID
                $this->data['patientid'] = $this->input->get('id');
                // User
                ...
                // Workout Log
                $this->data['form_workout_logs'] = $this->model_form_workout_log->get($this->data['patientid'], 'patient_id', 0, 0);
                $this->data['form_workout_log_counts'] = $this->model_form_workout_log->count_all($this->data['patientid'], 'patient_id');
